...
{
    [ToolboxBitmap(typeof(NumericTextBox),"P5_1_1184109.NumericTextBox.ico")]
    public partial class NumericTextBox: TextBox
    {
        ...
        //Rissing & Overriding OnKeyPress event
        ...
        protected override void OnKeyPress(System.Windows.Forms.KeyPressEventArgs e)
        {
            ...
            {
                //if the value of the ASCII converted char type (e.KeyChar) represent 0-9 
                //pass the event to Windows for default processing
                e.Handled = false;
                return;
            }
            //if the value of the ASCII converted char type (e.KeyChar) represent BACKSPACE
            //pass the event to Windows for default processing
            if (asciiInteger == 8)
            {
                e.Handled = false;
            ...
            //handle the evnt here by setting Handle=true which prevents the event from being 
